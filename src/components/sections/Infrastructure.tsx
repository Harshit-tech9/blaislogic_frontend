        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0 md:divide-x divide-black/10 dark:divide-white/10">
          {INFRASTRUCTURE_FEATURES.map((feature, index) => (
            ...
            >
              ...
              <div className="mt-auto pt-6 opacity-0 group-hover:opacity-100 transition-opacity text-sm font-semibold underline underline-offset-4 text-primary dark:text-white">
                Learn more
              </div>
            </div>
          ))}
